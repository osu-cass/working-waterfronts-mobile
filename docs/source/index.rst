...
++++++++
	...
	.. image:: ../_images/specificview.png
...
List
++++
	As the controller this file is responsible for linking all of
        the views and stores. In the top part of the file you will see
        all of the references and the controls that each page
        reference has. Then our first two functions deal with page
        transitions. As you navigate through the controller you will
        notice that the functions are broken out into sections for
        their respective views and are also ordered in the same way
        that elements in that view are laid out. 
